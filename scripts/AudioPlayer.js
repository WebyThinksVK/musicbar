!function(t) {
    ...
    window.AudioLayer = _audioplayer_audio_layer__WEBPACK_IMPORTED_MODULE_1__["default"],
        window.AudioUtils = {
            ...
            getContextPlaylist: function(t, e) {
                ...
                var o, a = getAudioPlayer(), s = AudioUtils.getAudioFromEl(t, !0), r = null, l = [], n = domData(t, "new-post"), d = !1, u = null, _ = AudioPlaylist.TYPE_TEMP, c = vk.id, p = {}, h = [], A = t, y = window.AudioPage && currentAudioPage(t), f = window.traverseParent || function(t, e) {
                ...
                if (m) {
                    ...
                    for (L && u.mergeWith({
                        accessHash: L
                             ...
                             y && y.getPageCurrentPlaylist() == u && y.getSortedList() ? u.initSortedList(y.getSortedList()) : s.isFromCurrentPlaylist || (u.removeSortedList(),
                                 u.shuffle(0)); A = domPN(A); )
                        h.push((A.id ? "#" + A.id : "") + (A.className ? "." + A.className : ""));
                    h = h.slice(0, 30),
                        h = h.filter(function(t) {
                            return !!trim(t)
                        }),
                        h = h.reverse().join(" / "),
                        h = document.location.href + " : " + h
    ...
    AudioPlayer.prototype._adsPlayAd = function(t, e, i) {
        ...
        return this._adman.onTimeRemained(function(t) {
            ...
            t ? i && i() : (this._adsPlaying = !0,
                ...
                setDocumentTitle(getLang("global_audio_ad")),
                void 0)
    }
    ,
    ...
    AudioPlayerHTML5.prototype.play = function(t) {
        this._stopFrequencyAnalise(),
        this._prefetchAudioEl.src == Object(_audioplayer_audio_unmask_source__WEBPACK_IMPORTED_MODULE_0__.audioUnmaskSource)(t) && this._prefetchAudioEl.readyState > AudioPlayerHTML5.STATE_HAVE_NOTHING && (this._setAudioNodeUrl(this._currentAudioEl, AudioPlayerHTML5.SILENCE),
